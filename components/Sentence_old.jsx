    ...
    <style jsx>
      {`
        .active_sentence_slot {
          ...
          height: 100%;
          overflow: hidden;
          /* We removed display: flex and centering here so it doesn't shrink the child */
        }
        .active_sentence_top_effect {
          ...
          pointer-events: none;
          z-index: 10; /* Added z-index to ensure it sits on top */
        }
        ...
        .active_sentence_content {
          ...
          display: flex;
          align-items: center; /* Vertically center the sentence */
          justify-content: center; /* Horizontally center the sentence words */
