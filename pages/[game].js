...
const Game = ({ returnString }) => (
  <div className="container">
    <Head>
      ...
      <meta property="og:image:secure_url" content={`https://grumbly.games/api/${returnString}`} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta property="og:image" content={`https://grumbly.games/api/square/${returnString}.png`} />
      <meta property="og:image:width" content="600" />
      <meta property="og:image:height" content="600" />
      <meta property="fb:app_id" content="220488252548780" />
      <meta property="og:type" content="website" />
      <meta property="og:url" content={`https://grumbly.games/details/${returnString}`} />
      ...
      <meta name="twitter:image" content={`https://grumbly.games/api/${returnString}`} />
      <meta name="twitter:domain" content={`https://grumbly.games/details/${returnString}`} />
    </Head>
